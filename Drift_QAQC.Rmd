...
# If Flag 3, replace Flowdiff with median.Flowdiff_s * SetTime
...
FlowmeterQAQC <- Flow.outlier %>%
  ...
  mutate(Flag_FM = ifelse(Flow_Outlier=="Both" | Flowdiff < 200 | (Flowdiff >= 50000 & Inundation2 ==FALSE) | Flowdiff >= 70000 , 3, 
         ...
         Flowdiff_adj = ifelse(Flow_s_MAD < 0.1, Flowdiff, ifelse(Flag_FM == 3 | Comment_SAMP == "FM", median.Flowdiff_s * SetTime, Flowdiff)))
```
