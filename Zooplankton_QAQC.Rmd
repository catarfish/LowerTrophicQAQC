...
# Fill in "ZoopNetType" as 150 for the rest that are not entered
# Checked with contractor data to confirm net type
...
# CPUE differs based on flowmeter used, net size, and meso vs. microzooplankton
  # First calculate the volumes: (diameter = 0.5m, (0.5m)^2 = 0.25m^2)
...
```{r cpue vis}
## Plots
ggplot(zoop_all, aes(Date, CPUE, col = ZoopNetType))+ geom_jitter() +
...
# Plot CPUE
ggplot(zoop_replaced, aes(x = ZoopNetType, y = CPUE_ed, col = ZoopNetType)) +
  facet_wrap(~StationCode, scales = "free") + 
...
### 13. Amount of zoop data replaced
