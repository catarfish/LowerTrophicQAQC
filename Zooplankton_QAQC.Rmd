...
cz2 <- cz1 %>%
  mutate(StartTime1 = ifelse(MeshSize ==150, StartTime, `50_SetTime`),
         ...
         VolSampled = ifelse(MeshSize ==150 & FlowMeterSpeed == "Regular", `150_V_reg`, 
...
zoop_all_2 <- zoop_all_1[, c("PhysicalDataID", "ZoopsDataID",
                         ...
                         "Subsample", "PropSubsampled", "VolSampled",
...
### 11. Recalculate values for Flowmeter Difference, CPUE, VolSampled
...
* "Replace" CPUE (and VolSampled) if Flowmeter value was changed (created new column CPUE_ed and VolSampled_ed) 
...
# Replace CPUE and VolSampled based on new Flowdiff values (new column)
zoop_replace_CP <- zoop_replace_FM %>%
  ...
  mutate(VolSampled_ed = ifelse(FlowMeterSpeed == "Regular", round(V_reg,3), round(V_low,3)))
...
zoop_final <- zoop_replaced[,c("Date", "Time", "StationCode", "WeatherCode", "Tide", "WY", 
                               ...
                               "PropSubsampled", "VolSampled", "VolSampled_ed",
